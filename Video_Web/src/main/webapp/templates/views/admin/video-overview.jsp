...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="/PS24803_TranVanTien_ASM/index" class="brand-link"> <img
				src="<c:url value='/templates/admin/dist/img/AdminLTELogo.png'/>"
				alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
				style="opacity: .8"> <span
				class="brand-text font-weight-light">TT ENTERTAIMENT</span>
			</a>
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item menu-open"><a href="<c:url value='admin'/>" class="nav-link active">
							...
							<tbody>
								<c:forEach items="${videos}" var="item">
									<tr>
										...
										<td>
											<a href="<c:url value='/admin/video?action=edit&href=${item.href}'/>" type="button" class="btn btn-block bg-gradient-success btn-sm">Edit</a>
											<button type="button" onClick="deleteVideo('${item.href}')" class="btn btn-block bg-gradient-danger btn-sm">Delete</button>
										</td>
									</tr>
								</c:forEach>
							</tbody>
	...
	<script>
		function deleteVideo(href) {
			$.ajax({
				url: '/PS24803_TranVanTien_ASM/admin/video?action=delete&href=' + href
			}).then(function(data) {
				window.lacation.href = "http://localhost:8080/PS24803_TranVanTien_ASM/admin/video?action=view";
			}).fail(function(error) {
