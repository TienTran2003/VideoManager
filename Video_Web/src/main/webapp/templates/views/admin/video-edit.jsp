...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="/PS24803_TranVanTien_ASM/index" class="brand-link">
...
<script>
	...
	$('#submitBtn').click(function() {
		...
		if(isEdit == 'true'){
			url = '/PS24803_TranVanTien_ASM/admin/video?action=edit&href=' + hrefOrigin;
		} else {
			url = '/PS24803_TranVanTien_ASM/admin/video?action=add';
		}
		...
		$.ajax({
			...
			window.location.href = "http://localhost:8080/PS24803_TranVanTien_ASM/admin/video?action=view";
		}).fail(function(error) {
